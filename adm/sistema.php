                ...
                <nav class="nav">
                        <div>
                            ...
                            <div class="nav__list">
                                ...
                                <span class="nav__name">Requerimentos</span>

                                <ion-icon name="chevron-down-outline" class="collapse__link"></ion-icon>

                               <ul class="collapse__menu">
                                    <li class="tte">
                                        <a href="zs/policia.php" class="collapse__sublink" target="kas">Membros</a>
                                        <a href="zs/hospital.html" class="collapse__sublink" target="kas">Contratos</a>
                                        <a href="zs/org.html" class="collapse__sublink" target="kas">Advertência</a>
                                        <a href="zs/habbo.html" class="collapse__sublink" target="kas">Aulas</a>
                                        </li>
                                </ul>
